  ...
  return new Command("component")
    ...
    .action(async (name: string | undefined, opts: Record<string, unknown>) => {
      ...
      try {
        ...
        const componentTsx = renderTemplate("component", "component", {
          name: kebabName,
          pascalName,
        ...
        const typesTs = renderTemplate("component", "types", {
          pascalName,
          styledComponents: opts.styledComponents,
          cssModule: opts.cssModule,
        });

        const indexTs = renderTemplate("component", "index", {
          name: kebabName,
          pascalName,
        });
        ...
        if (opts.tests) {
          const testTsx = renderTemplate("component", "test", {
            name: kebabName,
            pascalName,
          });
        ...
        if (opts.storybook) {
          const storyTsx = renderTemplate("component", "story", {
            name: kebabName,
            pascalName,
          });
