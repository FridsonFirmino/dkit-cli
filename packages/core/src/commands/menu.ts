...
export function createMenuCommand(): Command {
  return new Command("menu")
    ...
    .action(async () => {
        ...
        options: [
          ...(project.type === "none"
            ...
            : [
                ...
                {
                  value: "configure",
                  label: "Configure tools for this project",
                },
              ]),
      ...
      switch (action) {
        case "create":
          (await import("./create.js")).createProject();
          break;
        case "generate":
          (await import("./generate.js")).showGenerateMenu(project);
          break;
        case "configure":
          (await import("./configure.js")).showConfigureMenu(project);
          break;
        case "doctor": {
        ...
        case "clean":
          (await import("./clean.js")).promptClean(project);
          break;
        case "update":
          console.log(
          ...
          break;
        case "env":
          (await import("./env.js")).showEnvMenu(project);
          break;
        case "mobile":
          console.log(
            pc.dim(
